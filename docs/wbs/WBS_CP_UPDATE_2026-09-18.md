...
- W3-004 zone read — implementation complete with provisional M1 smoke catalog; re-validation pending
- W3-005 expedition start — implementation complete with provisional server duration provider; re-validation pending
- W3-006 expedition current state — complete
- W3-007 expedition claim — implementation complete with provisional server resolution/retention providers; re-validation pending
...
↓
CP-10 Guest bootstrap + API wiring — exploration-loop implementation complete; re-validation pending
↓
