...
- W3-009 equipment mutation — complete for current M1 backend scope
...
- W4-007 inventory/equipment minimum — complete for current M1 scope
...
- W5-003 optimistic-lock conflict tests — complete for current M1 scope
...
↓
CP-16 Equipment domain + atomic persistence/API — complete
↓
CP-17 Inventory/equipment minimum UI — complete
↓
CP-18 Claim/equipment race and failure validation — complete
↓
CP-19 Full M1 acceptance loop — complete
↓
...
## M1 milestone closure — 2026-09-23

M1 Playable Solo Prototype Definition of Done — complete.
...
→ equipment
→ retry/conflict safety
→ second exploration
```

Concurrency, payload/snapshot, and low-bandwidth bundle acceptance remain green at M1 closure.
