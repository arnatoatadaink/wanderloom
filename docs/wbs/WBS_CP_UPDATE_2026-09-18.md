...
### W4 Frontend
- W4-001 mobile shell — implementation complete; validation pending
- W4-002 destination card — implementation complete; validation pending
- W4-003 metrics panel — implementation complete; validation pending
- W4-004 duration selector — implementation complete; validation pending
- W4-005 exploration state screen — implementation complete; validation pending
- W4-006 result screen — implementation complete; validation pending
...
↓
CP-11 Mobile pre/exploring/result UI integration — implementation complete; validation pending
↓
